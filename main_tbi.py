...
import argparse
import time
from model_tbi import train, decode
...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='txbyimg')
    parser.add_argument('--main_path', type=str, default="./")
    parser.add_argument('--model_path', type=str, default="models")
    parser.add_argument('--decoding_path', type=str, default="decoding")
    parser.add_argument('--writetrans', type=str, default='./decoding/txt_order.devorder',
